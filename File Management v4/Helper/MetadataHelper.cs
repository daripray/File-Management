...
namespace File_Management_v4.Helper
{
    public class MetadataHelper
    {
            ...
            foreach (var dir in directories)
            {
                switch (dir)
                {
                    ...
                    case GpsDirectory gps:
                        ...
                        if (loc.HasValue)
                        {
                            Lat = loc.Value.Latitude.ToString("F6");
                            Long = loc.Value.Longitude.ToString("F6");
                        }
                        break;
        ...
        public void Clear()
        {
            ...
            Lat = Long = Author = Caption = ExposureTime = Aperture = null;
